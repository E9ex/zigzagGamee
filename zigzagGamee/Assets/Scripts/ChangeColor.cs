...
public class ChangeColor : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Mathf.Abs(fark.r)+Mathf.Abs(fark.g)+Mathf.Abs(fark.b)<.2f)
        {
            ikinciRenk = colors[IkinciRenkSec()];
        }
        zeminMat.color = Color.Lerp(zeminMat.color, ikinciRenk, 0.007f);
        Camera.main.backgroundColor = Color.Lerp(Camera.main.backgroundColor, ikinciRenk, 0.007f);
    }
